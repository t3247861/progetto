...
<?php include_once "cod_html2.php"?>
<?php
...
class ca_customers_view extends ca_customers {
	...
	function getFailureMessage() {
        $fail=new function_1();
        return $fail->getFailureMessage();
	}

	function setFailureMessage($v) {
        $fail=new function_1();
        $fail->setFailureMessage($v);
	}

	function getSuccessMessage() {
        $succ=new function_1();
        return $succ->getSuccessMessage();
	}

	function setSuccessMessage($v) {
        $succ=new function_1();
        $succ->setSuccessMessage($v);
	}

	function getWarningMessage() {
        $warn=new function_1();
        return $warn->getWarningMessage();
	}

	function setWarningMessage($v) {
        $warn=new function_1();
        return $warn->setWarningMessage($v);
	}
...
<?php } ?>
<?php } ?>
<?php $a_customers_view->ExportOptions->RenderOptions("body") ?>
<?php
...
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
	<?php if (MS_PAGINATION_STYLE==1) { // link ?>
		<?php
        $html1=new cod_html2();
        echo $html1->HTML_2($a_customers_view,$Language);
        ?>
...
<?php if ($a_customers->Export == "") { ?>
	<?php if (MS_PAGINATION_STYLE==1) { // link ?>
		<?php
            $html= new cod_html2();
            echo $html->HTML_2($a_customers_view,$Language);
        ?>
	<?php } elseif (MS_PAGINATION_STYLE==2) { // button ?>
		<?php
            $html2= new cod_html2();
            echo $html2->HTML_3($a_customers_view, $Language);
        ?>
	<?php } // end of link or button ?>
<div class="clearfix"></div>
<?php } ?>
